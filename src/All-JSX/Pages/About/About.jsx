    ...
    return (
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div className="w-full lg:w-6/12" data-aos="fade-right">
                    <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">We are here to Innovating for Success and Empowering Excellence </h2>
            ...
            <div className="relative mt-24">
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                    <div data-aos="fade-right" className="z-20 w-12 h-12 bg-gray-800 rounded-full flex justify-center items-center">
                    ...
                    <svg data-aos="fade-right" className="z-20" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg data-aos="fade-right" className="z-20 sm:block hidden" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="24" cy="24" r="24" fill="#1F2937" />
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                ...
                <div data-aos="fade-left" className="sm:block hidden">
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">400k User</p>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
            </div>
            <div className="sm:hidden block relative mt-8">
                <div data-aos="fade-right" className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            ...
            <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                <div data-aos="fade-down" className="w-full lg:w-6/12">
                ...
                <div className="w-full lg:w-6/12">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                        {/* <!-- Team Card --> */}
                        <div data-aos="flip-left" className="flex p-4 shadow-md">
                            <div className="mr-6">
                        ...
                        {/* <!-- Board Card --> */}
                        <div data-aos="flip-right" className="flex p-4 shadow-md">
                            <div className="mr-6">
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div data-aos="fade-left" className="w-full lg:w-5/12 flex flex-col justify-center">
            ...
            <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                <div data-aos="zoom-in"  className="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 pb-4">Our Story</h1>
                    <p className="font-normal text-base leading-6 text-gray-600 ">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.In the first place we have granted to God, and by this our present charter confirmed for us and our heirs forever that the English Church shall be free, and shall have her rights entire, and her liberties inviolate; and we will that it be thus observed; which is apparent from</p>
                </div>
                <div className="w-full lg:w-8/12 lg:pt-8">
                    <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                        <div data-aos="flip-left" className="p-4 pb-6 flex justify-center flex-col items-center">
